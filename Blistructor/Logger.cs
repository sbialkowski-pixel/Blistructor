...
namespace Blistructor
{
    public class Logger
    {
        private static readonly ILog log = LogManager.GetLogger("Cutter.Logger");
        ...
        public static void Setup()
        {
         ...
         //   hierarchy.Properties["requestId"] =
            ...
            defaultLogger.Layout = patternLayout;
            var levelFilter = new LevelRangeFilter();
            levelFilter.LevelMin = Level.Info;
            defaultLogger.AddFilter(levelFilter);
            defaultLogger.ActivateOptions();
           ...
           prod_roller.AppendToFile = false;
            ...
            hierarchy.Root.AddAppender(defaultLogger);
